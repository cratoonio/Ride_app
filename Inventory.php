...
<div class="pull-right"><a href="#" onclick="killHeader()" class="glyphicon glyphicon-minus-sign exit" style="padding: 15px; text-decoration: none;" ></a> </div>
<div class="jumbotron">
    ...
    <form method="POST" action="email_validation.php">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control input-sm" id="Quantity" placeholder="Quantity" name="Quantity">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control input-sm" id="WorkOrder" placeholder="Work Order" name="WorkOrder">
            </div>
