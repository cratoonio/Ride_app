...
foreach ($result as $i) {
    ...
    if($i->destinationS==$post['destination']){echo '<div class="col-xs-12"><div class="wellInfo" style="border-radius: 0px 0px 30px 30px;background-color: #f7cea4">' . $i->destinationS . '</div></div>';}else{echo '<div class="col-xs-12"><div class="wellInfo" style="border-radius: 0px 0px 30px 30px;">' . $i->destinationS . '</div></div>';}
