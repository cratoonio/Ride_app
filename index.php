...
<?php date_default_timezone_set('Asia/Tel_Aviv') ?>
    <div class="container" style="padding:3px" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="card col-lg-6 col-lg-offset-3 col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2  " style="padding: 0px" id="card">
            <form  id="give" accept-charset="UTF-8">
                <div class="back">
                    <div class="row">
                        <div class="center-block">
                            <!-- <span class="btn btn-sm btn-priary flipMe pull-right"></span> -->
                            <a  style="background:#DFF0D8;    padding: 3px 78px;text-decoration: none;"   class="text-center flipMe btn btn-default btn-sm form-control-green">אני הנהג</a>
                            <br><h3    class="text-center flipMe">אני הטרמפיסט</h3>

                        </div>

                    </div>
                <hr style=" width: 100% ; border-top:1pt solid #F4FFEF; " />
                    ...
                    <div id="withMoney" class="row bg-success"
                        ...
                        <div class="col-xs-10">
                            <h5 class="green">השתתפות בדלק</h5>
                                ...
                                <label for="נשנושים" class="btn btn-success">
...
<!--                                 <label class="btn btn-success">
                    ...
                    <div class="col-xs-1"></div>
                        ...
                        <div id="stops" class="col-xs-7">
                            </i>
                            <label for="stops">עובר ב:</label>
                        ...
                        <div id="stop2" class="col-xs-7" style="display: none;margin-top: 10px">
                            </i>
                            <label for="stops">וגם ב:</label>
                        ...
                        <div id="stop3" class="col-xs-7" style="display: none;margin-top: 10px">
                            </i>
                            <label for="stops">וגם ב:</label>
                    ...
                    <div class="col-xs-1"></div>
                        ...
                        <div class="col-xs-7">
                            <label for="destination">נוסע ל:</label>
     ...
     <div class="col-xs-1"></div>
                             ...
                             <div class="col-xs-3   ">
                                ...
                                <input type="number" class="form-control input-sm form-control-green"
                                       name="pass" data-toggle="tooltip" title="הכנס סיסמא פשוטה על מנת למחוק את הנסיעה" placeholder="מחיקה"  required>
                            </div>
                            <div class="col-xs-4 ">
...
<!--                          <div class="col-xs-2 pull-right"></div>-->
                     ...
                     <div class="col-xs-1 pull-right"></div>
                        ...
                        <button type="submit" style="margin-top: 2px;height: 70%   " name="submit" class="text-center form-control btn btn-default form-control-green btnMe">הכנס נסיעה
                        </button>
                            <div id='response'></div>
                        </div>
            ...
            <form id="get" accept-charset="UTF-8">
                <div class="front">
                    <div class="row">
                        <div class="center-block">
                            <!-- <span class="btn btn-sm btn-priary flipMe pull-right"></span> -->
                            <a   style="background:#DFF0D8;padding:3px 50px;text-decoration: none;"class="text-center flipMe btn btn-default btn-sm form-control-green">אני הטרמפיסט</a>
                                       <br><h3    class="text-center flipMe">אני הנהג</h3>
                        </div>
                    </div>
                    <hr style=" width: 100% ; border-top:1pt solid #F4FFEF; " />
                    <div class="row">
...
<!--                            --><?php //echo ltrim(date('H'), 0); ?>
               ...
               <div class="row">
                     <div class="col-xs-1 pull-right"></div>
                        <div class="col-xs-10 pull-right">
                        <button type="submit" style="margin-top: 2px;height: 70%   " name="submit" class="text-center form-control btn btn-default form-control-green btnMe">מצא נסיעה
                        </button>
                            <div style="height:20px" id='response1'></div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div style="color:#000;height:75px" class="modal-footer">
                    ...
                    <button type="submit" name="submit" class="text-center btn btn-default form-control-green" data-dismiss="modal"
                            aria-label="Close">שלח
                    </button>
                </div>
                </form>
...
בנוסף אתם נדרשים לציין את הישוב שבו נמצא המיקום החדש או הישוב הקרוב אליו ביותר.
</p>
                </div>
...
על מנת לבצע מחיקה נדרש להכניס שם, טלפון וסיסמת מחיקה שנבחרה בעת הכנסת הנסיעה.
</br>
כל נסיעה תימחק מתוצאות החיפוש יום לאחר התרחשותה באופן אוטומטי, חוץ מנסיעות מחזוריות שנשמרות באתר למשך כחודש.
</p>
                </div>
...
הקמנו את האתר כפלטפורמה לשיתוף ומציאת טרמפים, שיאפשר חלופה נוחה לקבוצות הטרמפים ברשתות החברתיות, עם הכנסת נסיעה וחיפוש טרמפ פשוטים ומהירים.  בנוסף, בכל חיפוש נסיעה, מתבצעת סריקה לא רק על המוצא והיעד שהוכנסו לשדות החיפוש, אלא על כל הישובים והאתרים הקרובים, שיוכלו להוות מענה רלוונטי למשתמש.
</br>
...
פרטי הנסיעה, וביניהם שם ומספר טלפון כפי שהוכנסו, יופיעו לכל משתמש המחפש נסיעה דומה במוצא, יעד וזמן.
</br>
כל נסיעה שהוכנסה תימחק מתוצאות החיפוש  יום לאחר מועד התרחשותה, מלבד נסיעות מחזוריות שימחקו חודש לאחר הכנסתן.
</br>
במידת הצורך ניתן להוריד את נסיעתך מתוצאות החיפוש מוקדם יותר, באמצעות כפתור מחיקת נסיעה בראש העמוד.
</br>
אנו ממליצים לקרוא את הדרכת השימוש באתר על מנת להבין את מגוון האפשרויות בו.
