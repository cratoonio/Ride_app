            ...
            <div class="front">
                <div class="row">
                    ...
                    <h3 class="center-block text-center col-xs-4">
                        <span style="" class="logo" data-toggle="modal" data-target="#myModal">CarHop<span
                                style="color: #ffffff;font-size:10px;vertical-align: super;font-weight: 400">2</span>er</span>
                    </h3>
                ...
                <div class="row row-app">
                    <div class="col-xs-8">
                        ...
                        <div angucomplete-alt id="ex1" input-name="origin" placeholder="Origin" maxlength="50"
                             pause="100" local-data="locations" search-fields="settlement,council,town"
                             title-field="settlement" minlength="1"
                             input-class="form-control input-sm form-control-green" match-class="highlight"></div>
                    </div>
                    ...
                    <div class="col-xs-3">
                        ...
                        <div class="switch">
                            <input id="switchMoney" name="withTerms" class="cmn-toggle cmn-toggle-round"
                                   type="checkbox">
                    ...
                    <div class="col-xs-12 ">
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            <label for="5" class="btn btn-success active">
                                <input type="radio" name="price" value="0" autocomplete="off" checked>0 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                            <label for="5" class="btn btn-success">
                                <input type="radio" name="price" value="5" autocomplete="off">5 <i class="fa fa-ils"
                                                                                                   style="font-size: 11px;"></i>
                            </label>
                            <label for="10" class="btn btn-success">
                                <input type="radio" name="price" value="10" autocomplete="off">10 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                            <label for="15" class="btn btn-success">
                                <input type="radio" name="price" value="15" autocomplete="off">15 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                            <label for="20" class="btn btn-success">
                                <input type="radio" name="price" value="20" autocomplete="off">20 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                            <label for="25" class="btn btn-success">
                                <input type="radio" name="price" value="25" autocomplete="off">25 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                            <label for="30" class="btn btn-success">
                                <input type="radio" name="price" value="30" autocomplete="off">30 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                            <label for="30" class="btn btn-success">
                                <input type="radio" name="price" value="35" autocomplete="off">35 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                            <label for="35" class="btn btn-success">
                                <input type="radio" name="price" value="40" autocomplete="off">40 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                            <label for="40" class="btn btn-success">
                                <input type="radio" name="price" value="45" autocomplete="off">45 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                            <label for="45" class="btn btn-success">
                                <input type="radio" name="price" value="50" autocomplete="off">50 <i
                                    class="fa fa-ils" style="font-size: 11px;"></i> </label>
                        </div>
                ...
                <div class="row row-app">
                    <div id="stops" class="col-xs-8">
                        ...
                        <div angucomplete-alt id="ex1" input-name="stops" placeholder="Stops" maxlength="50"
                             pause="100" selected-object="selectedCountry" local-data="locations"
                             search-fields="settlement" title-field="settlement" minlength="1"
                             input-class="form-control input-sm form-control-green" match-class="highlight"></div>
                ...
                <div class="row row-app">
                    ...
                    <div class="col-xs-8">
                        ...
                        <div angucomplete-alt id="ex1" input-name="destination" placeholder="Destination"
                             maxlength="50" pause="100" selected-object="selectedCountry" local-data="locations"
                             search-fields="settlement" title-field="settlement" minlength="1"
                             input-class="form-control input-sm form-control-green" match-class="highlight"></div>
                    </div>
                    <div class="col-xs-3">
                        ...
                        <div class="switch">
                            ...
                            <input id="switchTime" name="giveTime" class="cmn-toggle cmn-toggle-round "
                                   type="checkbox">
                    ...
                    <div class="col-xs-12 ">
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-success hideday active">
                                <input type="radio" name="date" value="<?php echo date("d/m/Y") ?>" id="Today"
                                       autocomplete="off" checked>Today</label>
                            <label class="btn hideday btn-success">
                                <input type="radio" name="date"
                                       value="<?php echo date("d/m/Y", strtotime("+1 days")) ?>" id="Tomorrow"
                                       autocomplete="off">Tomorrow </label>
                            <label class="btn hideday    btn-success">
                                <input type="radio" name="date"
                                       value="<?php echo date("d/m/Y", strtotime("+2 days")) ?>" id="2days"
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-success">
                                <input type="checkbox" name="time[0]" value="morning"
                                       autocomplete="off">Morning</label>
                            <label class="btn btn-success">
                                <input type="checkbox" name="time[1]" value="afternoon"
                                       autocomplete="off">Afternoon</label>
                            <label class="btn btn-success">
                                <input type="checkbox" name="time[2]" value="evening"
                                       autocomplete="off">Evening</label>
                ...
                <div class="row row-app">
                    ...
                    <textarea class="form-control form-control-green" placeholder="Enter any edition information..."
                              data-toggle="tooltip"
                              title="Please enter any information regarding the trip" data-placement="bottom"
        ...
        <div class="back">
            ...
            <div class="row row-app">
                <div class="col-xs-8">
                    ...
                    <div angucomplete-alt id="ex1" input-name="origin" placeholder="Origin" maxlength="50" pause="100"
                         selected-object="selectedCountry" local-data="locations" search-fields="settlement"
                         title-field="settlement" minlength="1" input-class="form-control input-sm form-control-green"
            ...
            <div class="row row-app">
                <div class="col-xs-8">
                    ...
                    <div angucomplete-alt id="ex1" input-name="destination" placeholder="Destination" maxlength="50"
                         pause="100" selected-object="selectedCountry" local-data="locations" search-fields="settlement"
                         title-field="settlement" minlength="1" input-class="form-control input-sm form-control-green"
                         match-class="highlight"></div>
                </div>
                <div class="col-xs-3    ">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: #000000;" id="myModalLabel">Welcome young <i class="green">grasshoppers!</i>
                </h4>
            </div>
