                            ...
                            <div class="col-xs-4">
                             ...
                             <div class="col-xs-4">
                                <label for="pass">
                                    Password</label>
                                <input type="number" class="form-control input-sm form-control-green"
                                       name="pass" data-toggle="tooltip" title="enter a password so you can delete you trip if you need to" placeholder="Password for delete"  required>
                            </div>
                        </div>
                    </div>
                    <div class="row row-app">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="color:#000"
                        id="myModalLabel">you can delete you trip hear.
                    </h4>
                </div>
                <form  id="delete" accept-charset="UTF-8">
                <div style="color:#000000" class="modal-body">
                    <p>To delete you trips you need your <b>name</b> <b>phone</b> and
                    <b>Password</b> </p>
                    <div class="row">
                        <div class="col-xs-12">
                    <label for="newSett" name="name">Name</label>
                        <input type="text" class="form-control form-control-green" name="name" placeholder="Name" required="">
                    <label for="newSett" name="phone">Phone Number</label>
                        <input type="text" class="form-control form-control-green" name="phone" placeholder="Phone Number" required="">
                    <label for="newSett" name="password">Password</label>
                        <input type="text" class="form-control form-control-green" name="password" placeholder="password" required="">
                        </div>
                        </div>
                </div>
                <div style="color:#000;height:75px" class="modal-footer">
